...
int coge_get_joystick_id(int i) { return GLFW_JOYSTICK_1 + i; }
...
void coge_update_joystick() {
    ...
    if (g_coge_joystick_present) {
        ...
        g_coge_joystick_axes = glfwGetJoystickAxes(g_coge_joystick_id,
                                                   &g_coge_joystick_axes_count);
        g_coge_joystick_buttons = glfwGetJoystickButtons(
            g_coge_joystick_id, &g_coge_joystick_button_count);
    }
}
...
int coge_get_joystick_axes_count() { return g_coge_joystick_axes_count; }

int coge_get_joystick_button_count() { return g_coge_joystick_button_count; }

int coge_is_joystick_present() { return g_coge_joystick_present; }

const char *coge_get_joystick_name() { return g_coge_joystick_name; }
