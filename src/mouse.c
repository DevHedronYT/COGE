...
void coge_mouse_button_callback(GLFWwindow *window, int button, int action,
                                int mods) {
...
double coge_get_mouse_pos_x() { return g_coge_mouse_pos_x; }
double coge_get_mouse_pos_y() { return g_coge_mouse_pos_y; }
...
int coge_mouse_button(int button) { return g_coge_mouse_buttons[button]; }
