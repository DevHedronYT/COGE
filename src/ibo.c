...
void coge_gen_ibo_t(coge_ibo_t *indexBuffer) {
    ...
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, indexBuffer->m_size,
                 indexBuffer->m_data, indexBuffer->m_usage);
...
void coge_unbind_ibo_t() { glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, 0); }
