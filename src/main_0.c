...
f32_t * create_vertices_arr(f32_t * vertices, ge_v2_t pos, i32_t size, i32_t id) {
    vertices[0] = pos.x; vertices[1] = pos.y; vertices[2] = 0.0f; vertices[3] = 0.0f; vertices[4] = 0.5f; vertices[5] = id;
    vertices[6] = pos.x; vertices[7] = pos.y + size; vertices[8] = 0.0f; vertices[9] = 1.0f; vertices[10] = 1.5f; vertices[11] = id;
    vertices[12] = pos.x + size; vertices[13] = pos.y; vertices[14] = 1.0f; vertices[15] = 0.0f; vertices[16] = 1.75f; vertices[17] = id;
    vertices[18] = pos.x + size; vertices[19] = pos.y + size; vertices[20] = 1.0f; vertices[21] = 1.0f; vertices[22] = 1.2f; vertices[23] = id;
